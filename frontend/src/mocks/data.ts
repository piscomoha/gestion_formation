  ...
  affectations: [
    {
      ...
      idModule: 1,
      idGroupe: 1,
      groupe: { libelle: "DD-101", idFiliere: 1 },
      module: { libelle: "React et TypeScript", idModule: 1 },
      anneeScolaire: { libelle: "2025/2026", idAnneeScolaire: 2 },
    },
    {
      idAffectation: 2,
      idAnneeScolaire: 2,
      ...
      idGroupe: 1,
      groupe: { libelle: "DD-101", idFiliere: 1 },
      module: { libelle: "Bases de donnees", idModule: 2 },
      anneeScolaire: { libelle: "2025/2026", idAnneeScolaire: 2 },
    },
    {
      idAffectation: 3,
      ...
      idModule: 3,
      idGroupe: 3,
      groupe: { libelle: "ID-201", idFiliere: 2 },
      module: { libelle: "Administration Linux", idModule: 3 },
      anneeScolaire: { libelle: "2025/2026", idAnneeScolaire: 2 },
    },
  ...
  notes: [
    {
      ...
      controle_5: null,
      efm: 16,
      stagiaire: { nom: "Ziani", prenom: "Imane" },
      affectation: {
        groupe: { libelle: "DD-101" },
        module: { libelle: "React et TypeScript" },
      },
    },
    {
      idNote: 2,
      ...
      controle_5: null,
      efm: 13,
      stagiaire: { nom: "Tazi", prenom: "Omar" },
      affectation: {
        groupe: { libelle: "DD-101" },
        module: { libelle: "React et TypeScript" },
      },
    },
    {
      ...
      controle_5: null,
      efm: 15,
      stagiaire: { nom: "Fassi", prenom: "Lina" },
      affectation: {
        groupe: { libelle: "DD-101" },
        module: { libelle: "Bases de donnees" },
      },
    },
  ] satisfies Note[],
};

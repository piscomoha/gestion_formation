...
import { StagiairePortalPage } from "@/pages/stagiaire/StagiairePortalPage";
    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            children: [{ path: "formateur", element: <FormateurWorkspacePage /> }],
          },
          {
            element: <ProtectedRoute roles={["stagiaire"]} />,
            children: [{ path: "stagiaire", element: <StagiairePortalPage /> }],
          },
